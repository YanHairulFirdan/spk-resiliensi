...
<head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="{{ asset('css/plugins/nprogress/nprogress.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('css/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" />
  ...
  <![endif]-->
    <script src="{{ asset('css/plugins/nprogress/nprogress.js') }}"></script>
</head>
