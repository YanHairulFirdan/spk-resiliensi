...
<head>
    ...
    <!-- Styles -->
    <?php echo $__env->yieldContent('stepperstyle'); ?>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white text-bold" href="<?php echo e(url('/')); ?>">
                    <b><?php echo e(config('Resilience', 'Resilience')); ?></b>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/"><?php echo e(__('Home')); ?></a>
                        </li>
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="<?php echo e(route('login')); ?>"><?php echo e(__('Masuk')); ?></a>
                            </li>
                        ...
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/teacher"><?php echo e(__('Guru')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
        </nav>
        <?php if(Request::is('kuisioner')): ?>
            <?php
                $index = 3;
            ?>
        <?php else: ?>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner h-50">
                    <div class="carousel-item h-25 active">
                        <img class="d-block w-100" src="<?php echo e(asset("img/images/banners/banner-0.jpg")); ?>"
                            alt="First slide">
                    </div>
                    <div class="carousel-item h-25">
                        <img class="d-block w-100" src="<?php echo e(asset("img/images/banners/banner-1.jpg")); ?>"
                            alt="First slide">
                    </div>
                    <div class="carousel-item h-25">
                        <img class="d-block w-100" src="<?php echo e(asset("img/images/banners/banner-2.jpg")); ?>"
                            alt="First slide">
                    </div>
                </div>
            ...
            <?php if(!Request::is('/')): ?>
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <?php if(Request::is('kuisioner') || Request::is('motivation') || Request::is('result')): ?>
                                <div class="container-fluid">
                                    <?php echo $__env->make('components.formStepper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\spk-resiliensi\resources\views/layouts/app.blade.php ENDPATH**/ ?>