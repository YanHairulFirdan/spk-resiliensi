            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#app"
                        ...
                        <span class="nav-text">Aspek</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse" id="app" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            <li>
                                <a class="sidenav-item-link" href="/admin/aspect">
                ...
                <li class="has-sub">
                    ...
                    <ul class="collapse" id="components" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            <li>
                                <a class="sidenav-item-link" href="/admin/statement">
                ...
                <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#forms"
                        ...
                        <span class="nav-text">Kuisioner</span> <b class="caret"></b>
                    </a>
...
<?php /**PATH C:\laragon\www\spk-resiliensi\resources\views/components/adminsidebar.blade.php ENDPATH**/ ?>