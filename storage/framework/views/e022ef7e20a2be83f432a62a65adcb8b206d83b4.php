<form method="POST" action="<?php echo e(route('register')); ?>">
    ...
    <div class="form-group">
        <div class="">
            <input type=" text" class="form-control input-lg <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        <div class="">
            <input id="username" type="text" class="form-control input-lg <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        <div class="">
            <select name="class" id="class" class="form-control" value="<?php echo e(old('class')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        <div class="">
            <input id="phoneNumber" type="text" class="form-control input-lg <?php $__errorArgs = ['phone number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="phoneNumber" required placeholder="Nomor HP">
...
</form><?php /**PATH C:\laragon\www\spk-resiliensi\resources\views/components/registerForm.blade.php ENDPATH**/ ?>