            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-md-6 col-12 order-md-2 p-0">
                        <img src="<?php echo e(asset('img/images/cuteanimated-43.jpg')); ?>" class="image-thumbnail" width="100%"
                            alt="">
                    </div>
            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-sm-6 col-12 p-0">
                        <img src="<?php echo e(asset('img/images/students.jpg')); ?>" class="image-thumbnail" width="100%"
                            alt="">
                    </div>
                ...
                <div class="d-flex justify-content-center mt-5">
                    <a href="<?php echo e(route('user.quiz.index')); ?>" class="btn btn-lg btn-outline-primary" style="text-transform: initial">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\spk-resiliensi\resources\views/home.blade.php ENDPATH**/ ?>